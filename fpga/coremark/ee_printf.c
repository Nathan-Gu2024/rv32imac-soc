...
/* uart_mmio.v's register layout: TX_DATA at +0x0, TX_STATUS at +0x4,
 * bit 0 of TX_STATUS = tx_ready. Same base/polling pattern as
 * fpga/tests/uart.c. */
#define UART_TX_DATA   (*(volatile unsigned int *)0x40001000)
#define UART_TX_STATUS (*(volatile unsigned int *)0x40001004)
